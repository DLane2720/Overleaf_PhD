...
% Comparison of point cloud density within the camera \ac{FOV} reveals the Livox advantage.
...
% The three Livox sensors and the cameras within the enclosure cover the same 165-degree \ac{FOV} in the forward direction of travel.
...
% The Velodyne HDL-32E units provide the omnidirectional awareness required for autonomous navigation, while the Livox Horizon sensors optimize point cloud density specifically within the forward camera \ac{FOV} for fusion research.
