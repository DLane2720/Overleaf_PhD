...
Six cameras are encased in a waterproof camera enclosure
\textcolor{red}{[Insert Camera Enclosure Image]}
...
The visible spectrum camera suite on the Minion platform is designed to balance two factors are particularly important for maritime perception: imaging resolution and dynamic range.  
Resolution determines the ability to resolve small targets at distance.
...
\subsubsection{Comparison and Role in Platform Design}
...
In contrast, the IMX490 HDR camera combines comparable field of view with substantially greater dynamic range, enabling detail preservation across bright and shaded regions within the same frame.  
...
Horizontal Field of View & 65 degree \\
...
Three Livox units deployed together achieve combined coverage of approximately 165 degree × 25.1 degree, providing complete horizontal overlap with the camera array and covering approximately 77\% vertically \cite{thompson2023}.
