...
Notably, vision-based detection methods such as YOLO~\cite{ultralytics}, demonstrate strong performance on automotive benchmarks~\cite{geiger2012} but experience degradation under extreme illumination variations.
...
Recent surveys of maritime autonomy~\cite{bae2023, zhang2021, roriz2022, wang2020a, bai2022} identify perception as a critical enabling technology, yet systematic performance characterization of these methods in maritime operational conditions remains limited.
...
Transfer learning from large-scale terrestrial datasets (ImageNet, COCO~\cite{krizhevsky2017, lin2015, feng2021}) has become standard practice for maritime detection, yet it introduces domain adaptation challenges.
...
Hybrid architectures (PV-RCNN~\cite{shi2019, shi2020}) combine the strengths of point-based and voxel-based processing, achieving state-of-the-art automotive accuracy but assuming dense ground plane returns that do not hold for maritime applications~\cite{feng2021}.
