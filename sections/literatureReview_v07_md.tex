...
Notably, vision-based detection methods 
% using single-stage architectures 
such as YOLO~\cite{ultralytics}, have achieved near-human accuracy on automotive benchmarks~\cite{geiger2012}.
