...
\textcolor{red}P{"Filter Points" looks to appear to have a linear histogram, with an upper bound to the number of points returned most frequently. "Add Points" looks to have a near-linear to somewhat logarithmic scaling.}
